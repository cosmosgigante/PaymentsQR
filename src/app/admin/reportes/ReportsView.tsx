...
import { ArrowLeft, TrendingUp, Receipt, ShoppingBag, CreditCard, Banknote, BarChart3 } from "lucide-react";
            ...
            {[7, 14, 30].map((d) => (
              <button
                ...
                className={`text-xs font-bold px-3 py-1.5 rounded-lg transition-all ${
                  range === d ? "bg-white text-blue-900" : "bg-white/15 text-white/70 hover:bg-white/25"
                }`}
              >
                {d} días
              </button>
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 py-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <StatCard
              ...
              value={`$${data.totalRevenue.toLocaleString("es-AR")}`}
              label="Facturado"
            />
            <StatCard
            ...
            <StatCard
              ...
              value={`$${Math.round(data.avgTicket).toLocaleString("es-AR")}`}
            ...
            <StatCard
              ...
              value={`${data.onlineOrders} / ${data.cashierOrders}`}
              label="Online / Caja"
            />
          </div>
